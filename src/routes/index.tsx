  ...
  return <>
    <main class="flex flex-row items-center justify-center w-fit">
      ...
      <p class="px-10 text-white font-[Space_Mono]">
        ...
        <span class="text-yellow-300"><b>georgia tech</b></span><br />

        <span class="text-lime-300"><b>+</b></span> director of avionics @&nbsp;
        <span class="text-yellow-300"><b>yjsp</b></span><br />

        <span class="text-cyan-300"><b>+</b></span> intern @ [
          <span class="text-white"><b>spacex</b></span>,&nbsp;
          <span class="text-blue-500"><b>northrop grumman</b></span>,&nbsp;
          <span class="text-lime-500"><b>silvervine</b></span>
        ]<br />
